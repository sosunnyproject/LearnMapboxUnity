namespace Mapbox.Editor
{
	...
	public class PrefabItemOptionsDrawer : PropertyDrawer
	{
		...
		private void ShowCategoryOptions(SerializedProperty property)
		{
			...
			categoryProp.intValue = 0; // (int)(LocationPrefabCategories)(EditorGUILayout.EnumFlagsField(categoriesDropDown, (LocationPrefabCategories)categoryProp.intValue));
			// Debug.Log((LocationPrefabCategories)categoryProp.intValue);
			if (EditorGUI.EndChangeCheck())
			{
				EditorHelper.CheckForModifiedProperty(property);
			}
